        ...
        <template v-for="product in products" v-bind:key="product.id">
          <tr>
              ...
              <a href="#">
                ...
                <form action="" method="POST">
                  <button class="text-gray-700 md:ml-4">
                    <small v-on:click.prevent="destroy(product.id)">-- Supprimer le produit --</small>
                  </button>
                </form>
              </a>
            </td>
            ...
            <td class="hidden text-right md:table-cell">
              <span class="text-sm lg:text-base font-medium" v-text="product.price">
          ...
          <div class="p-4">
              ...
              <a href="/checkout">
                <button class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
                  ...
                  <span class="ml-2 mt-5px">Passez au paiement </span>
                </button>
              </a>
          </div>
        </div>
